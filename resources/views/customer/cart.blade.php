                            ...
                            <div class="row g-0">
                                ...
                                <div class="col-md-8">
                                    <div class="card-body">
                                        ...
                                        <p class="card-text">Jumlah Produk : {{ $d->quantity }}</p>
                                        <button type="button" class="btn shadow btn-outline-warning" data-bs-toggle="modal"
                                            data-bs-target="#editQty-{{ $d->id }}">
                                            Edit
                                        </button>

                                        <button type="button" class="btn shadow btn-outline-danger" data-bs-toggle="modal"
                                            ...
                                            <div class="modal-body">
                                                ...
                                                <div class="row">
                                                    <div class="col-6 col-md-6">
                                                        <div>
                                                            <span>{{ $d->product->new_price !== $d->product->price ? $d->product->new_price : '' }}</span>
                        ...
                        @else
                            ...
                            <div class="row justify-content-between">
                                <div class="col float-start">
                                    <p class="card-text"><strong>Total Harga</strong></p>
                                </div>
                                <div class="col float-end" style="color: green;">Rp. {{ $total_harga }}</div>
